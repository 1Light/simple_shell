...
/**
 * struct liststr - It is a singly linked list
 * @num: The number field considered
 * @str: The string
 ...
 *@readfd: The fd from to read line input
...
/**
 *struct builtin - It has a builtin string
 *@type: The builtin command flag indicator
