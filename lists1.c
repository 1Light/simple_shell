...
/**
 * list_to_strings - Gives an array of strings
...
/**
 * node_starts_with - Gives node whose string begins with a prefix
 * @node: The pointer to list head
 * @prefix: The string to resemble
 * @c: The next character after matching
 *
 ...
 *
 * Return: The index of the node or else -1
 */
